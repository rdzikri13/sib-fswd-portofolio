...
<?php $__env->startSection('isihalaman'); ?>
    <h3><center>Daftar Petugas Perpustakaan Sejarah UPI</center></h3>

    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPetugasTambah" style="back">
        Tambah Data Petugas
    </button>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DZIKRI\SEMESTER 6 - (Feb-Jun 2023) = 20 SKS\(MSIB) Studi Independen - PT Arkatama Multi Solusindo\Tugas Akhir\Portofolio\Perpustakaan-Sejarah-UPI\resources\views/halaman/view_petugas.blade.php ENDPATH**/ ?>